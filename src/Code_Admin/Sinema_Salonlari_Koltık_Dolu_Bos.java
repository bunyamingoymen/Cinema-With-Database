...
public class Sinema_Salonlari_Koltık_Dolu_Bos extends Sinema_Salonlari {
    ...
    protected boolean search(String koltuk, int seans_id) {
    ...
    protected void bir_koltuk_dolu(int seans_id) {
